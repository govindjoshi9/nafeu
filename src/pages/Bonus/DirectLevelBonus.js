...
function DirectLevelBonus() {
  ...
  //meta title
  document.title = "Direct Level Bonus "

  return (
    <div className="page-content">
      <div className="container-fluid">
        <Breadcrumbs title="Direct Level Bonus" breadcrumbItem="Summary" />
...
DirectLevelBonus.propTypes = {
  preGlobalFilteredRows: PropTypes.any,
}

export default DirectLevelBonus
